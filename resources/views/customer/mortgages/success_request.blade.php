@extends('layouts.app')
@section('title', 'Request Mortgages')
@section('content')
    <x-nav-tedja />
     <div class="flex justify-center gap-[50px] mt-[202px] mb-[70px]">
            ...
            <div class="flex flex-col w-[499px] shrink-0 gap-[33px] justify-center items-center">
                ...
                <div class="flex items-center justify-center gap-3">
                    <a href="{{ route('dashboard.mortgages')}}" class="rounded-full py-[14px] px-5 w-[194px] text-center font-semibold text-white bg-tedja-black">
                        My Mortgages
                    </a>
