                ...
                <div class="flex flex-col gap-4" id="PriceDetails">
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex items-center justify-between">
                            ...
                            <strong class="font-semibold">Rp {{ number_format($interest->house->price,0, '', '.') }}</strong>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                <img src={{ asset("assets/images/icons/note.svg")}} alt="icon" class="size-6 shrink-0">
                    ...
                    <div class="flex items-center gap-5">
                        ...
                        <div class="flex flex-col gap-0.5">
                            <div class="flex items-center gap-0.5">
                                ...
                                <img src={{ asset("assets/images/icons/verify.svg")}} class="size-5 flex shrink-0" alt="icon">
                            </div>
                ...
                <div class="flex flex-col gap-4" id="KPRPaymentDetails">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <strong class="font-semibold"><span id="monthly-insurance">Rp 900000</span></strong>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                <img src={{ asset("assets/images/icons/note.svg")}} alt="icon" class="size-6 shrink-0">
                            ...
                            <strong class="font-bold text-xl text-tedja-blue"><span id="loan-with-interest">Rp 0</span></strong>
                        </div>
                    </div>
                </div>
            </section>
            <form action="{{ route('front.interest.submitted') }}" method="POST" enctype="multipart/form-data" id="Request-Mortage"
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <label id="Input-File-Trigger" type="button"
                        ...
                        <img src={{ asset("assets/images/icons/task-square.svg")}} class="flex size-6 shrink-0" alt="icon">
                        <p id="File-Label" class="text-tedja-secondary">Add an attachment to request</p>
                        <input type="file" name="document" required id="File-Input" class="absolute opacity-0">
                    </label>
                </div>
                <hr class="border-[#F2F2F4]">
