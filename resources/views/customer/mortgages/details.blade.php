@extends('layouts.app')
@section('title', 'details mortgages')
@section('content')
                    ...
                    <section id="General" class="flex flex-col gap-[24px]">
                        ...
                        <ul class="flex flex-col gap-[24px]">
                            ...
                            <li class="active group">
                                <a href="{{ route('dashboard.mortgages') }}">
                                    <div class="relative flex items-center gap-[6px]">
                ...
                <div class="flex items-center gap-5">
                    ...
                    <button id="Profile" class="relative">
                        ...
                        <ul
                            ...
                            <li>
                                <a href="#" class="hover:text-tedja-blue transition-all duration-300">My
                                    Mortgages</a>
                            </li>
                            <li>
                        ...
                        <div class="flex flex-col gap-5 w-full">
                            <section id="Title" class="flex items-center justify-between">
                                <div class="flex flex-col gap-[6px]">
                                    <h2 class="font-bold text-[20px] leading-[30px]">{{ $mortgageRequest->house->name }}</h2>
                                    <div class="flex items-center gap-[6px]">
                                        <img src={{ asset('assets/images/icons/location.svg') }} alt="icon"
                                            class="shrink-0 size-6">
                                        <p class="font-semibold">{{ $mortgageRequest->house->city->name }}</p>
                                    </div>
                                </div>
                                @if ($mortgageRequest->status == 'Waiting for Bank')
                                    <span class="bg-tedja-orange rounded-full py-[6px] px-[10px] font-semibold">Waiting for Bank</span>
                                @endif
                                @if ($mortgageRequest->status == 'Approved')
                                    <span class="bg-tedja-blue rounded-full text-white py-[6px] px-[10px] font-semibold">Approved</span>
                                @endif
                                 @if ($mortgageRequest->status == 'Rejected')
                                    <span class="bg-tedja-red rounded-full text-white py-[6px] px-[10px] font-semibold">Rejected</span>
                                @endif
                            </section>
                            <section id="Points" class="grid grid-cols-3 gap-x-[18px] gap-y-[12px]">
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    ...
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgageRequest->house->bedroom }} Bedroom</p>
                                </div>
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src={{ asset('assets/images/icons/building.svg') }} alt="icon"
                                        class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgageRequest->house->land_area }} M²</p>
                                </div>
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src={{ asset('assets/images/icons/note-favorite.svg') }} alt="icon"
                                        class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgageRequest->house->certificate }}</p>
                                </div>
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src={{ asset('assets/images/icons/slider-horizontal.svg') }} alt="icon"
                                        class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgageRequest->house->bathroom }} Bathroom</p>
                                </div>
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src={{ asset('assets/images/icons/maximize.svg') }} alt="icon"
                                        class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgageRequest->house->building_area }} M²</p>
                                </div>
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src={{ asset('assets/images/icons/flash.svg') }} alt="icon"
                                        class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $mortgageRequest->house->electric }} Watts</p>
                                </div>
                            </section>
                        </div>
                    </div>
                                        ...
                                        <section id="PriceDetails"
                                            ...
                                            <div class="flex flex-col gap-4">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <strong class="font-semibold">Rp {{ number_format($mortgageRequest->house->price,0, '', '.') }}</strong>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap-2">
                                                        <img src={{ asset('assets/images/icons/note.svg') }}
                                            ...
                                            <div class="flex flex-col gap-4">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <strong class="font-semibold">
                                                        Rp {{ number_format($mortgageRequest->dp_total_amount,0, '', '.') }} 
                                                ...
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <strong class="font-semibold">
                                                        Rp {{ number_format($mortgageRequest->loan_total_amount, 0, '','.') }}
                                                    </strong>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap-2">
                                                    ...
                                                    <strong class="font-semibold">
                                                        Rp {{ number_format($mortgageRequest->monthly_amount, 0, '','.') }}
                                                    </strong>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap-2">
                                                ...
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <strong class="font-bold text-[20px] leading-[30px] text-tedja-blue">
                                                        Rp {{ number_format($mortgageRequest->loan_interest_total_amount, 0, '','.') }}
                                                    </strong>
                                                </div>
                                            </div>
                                        </section>
                                        ...
                                        <section id="BankKPRDetails"
                                            ...
                                            <div class="bank flex items-center gap-5">
                                                <div class="w-[99.4px] h-[70px] shrink-0 flex justify-center items-center">
                                                    <img src={{ Storage::url($mortgageRequest->interests->bank->photo) }}
                                            ...
                                            <div class="flex flex-col gap-4">
                                                ...
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <strong class="font-semibold">
                                                        Rp {{ number_format($mortgageRequest->remaining_loan_amount, 0, '','.') }}
                                                    </strong>
                                                </div>
                                 ...
                                 <section id="Available" class="flex flex-col gap-5">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <a href="{{ route('dashboard.installment.payment', $mortgageRequest) }}">
                                            <div class="rounded-full py-[14px] px-5 bg-tedja-green font-semibold">Make a New Payment</div>
                                        </a>
                                    </div>
                                    <div class="flex flex-col gap-5">
                                        @forelse ($mortgageRequest->installments as $installments)
                                        <div class="flex items-center justify-between p-[10px] rounded-[30px] border border-[#F2F2F4]">
                                            <div class="flex items-center gap-[54px]">
                                                ...
                                                <div class="flex flex-col gap-[2px]">
                                                    <h5 class="text-sm leading-[21px] text-tedja-secondary">Grand Total</h5>
                                                    <strong class="font-bold">
                                                        Rp {{ number_format($installments->grand_total_amount,0, '', '.') }}
                                                    </strong>
                                                </div>
                                            </div>
                                            <span class="font-semibold text-[#FAFAFA] rounded-full bg-tedja-blue px-[10px] py-[6px]">Settlement</span>
                                            <div class="flex flex-col gap-[2px]">
                                                <h5 class="text-sm leading-[21px] text-tedja-secondary">Payment</h5>
                                                <strong class="font-bold">{{ $installments->no_of_payment }}</strong>
                                            </div>
                                            <div class="flex flex-col gap-[2px]">
                                                <h5 class="text-sm leading-[21px] text-tedja-secondary">Date</h5>
                                                <strong class="font-bold">{{ $installments->created_at->format('d M, Y') }}</strong>
                                            </div>
                                            <a href="{{ route('dashboard.installment.details', $installments) }}" class="shrink-0">
