                ...
                <div class="flex items-center gap-5">
                    ...
                    <button id="Profile" class="relative">
                        ...
                        <ul
                            ...
                            <li>
                                <a href="index.html" class="hover:text-tedja-blue transition-all duration-300">Logout</a>
                            </li>
                        </ul>
                    </button>
                </div>
            ...
            <main class="flex w-full flex-col justify-center gap-[30px] pt-[28px] pb-[70px]">
                <nav>
                    <ol class="flex items-center gap-[14px]">
                        ...
                        <li>/</li>
                        <li>
                            <a href="{{ route('dashboard.mortgage.detilas', $mortgageRequest) }}">Details</a>
                        </li>
                        <li>/</li>
                        <li>
                ...
                <div class="flex gap-[30px]">
                    <section id="Hero"
                        ...
                        <div class="w-full h-[240px] rounded-[30px] overflow-hidden justify-center items-center">
                            <img src={{ asset('assets/images/thumbnails/installment-details.png') }} alt="image"
                                class="size-full object-cover">
                        </div>
                        <div class="flex flex-col gap-[18px] px-[10px]">
                            <div class="flex flex-col gap-[6px]">
                                <h2 class="font-bold text-lg leading-[27px]">{{ $mortgageRequest->house->name }}</h2>
...
@push('after-scripts')
    ...
    <script type="text/javascript">
        ...
        payButton.addEventListener('click', function(e) {
            e.preventDefault();
            fetch('{{ route('dashboard.installment.payment_status_store_midtrans') }}', {
                method: "POST",
                headers: {
                ...
                if(data.snap_token){
                    ...
                    snap.pay(data.snap_token, {
                        ...
                        onPending: function(result) {
                            ...
                            window.location.href = '{{ route('dashboard.mortgages') }}'
                        },
