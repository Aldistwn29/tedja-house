@extends('layouts.app')
@section('title', 'Details Installments')
@section('content')
            ...
            <main class="flex w-full flex-col justify-center gap-[30px] pt-[28px] pb-[70px]">
                <nav>
                    <ol class="flex items-center gap-[14px]">
                        <li>
                            <a href="{{ route('dashboard.mortgages') }}">Mortgages</a>
                        </li>
                        <li>/</li>
                        <li>
                            <a href="{{ route('dashboard.mortgage.detilas', $installmentDetails->mortgageRequest->id) }}">Details</a>
                        </li>
                        <li>/</li>
                        <li>
                            <span class="{{ route('dashboard.installment.details', $installmentDetails->id) }}">Installment</span>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="flex gap-[30px]">
                    <section id="Hero"
                        ...
                        <div class="w-full h-[240px] rounded-[30px] overflow-hidden justify-center items-center">
                            <img src={{ Storage::url($installmentDetails->mortgageRequest->house->thumbnail) }} alt="image"
                                class="size-full object-cover">
                        </div>
                        <div class="flex flex-col gap-[18px] px-[10px]">
                            <div class="flex flex-col gap-[6px]">
                                <h2 class="font-bold text-lg leading-[27px]">{{ $installmentDetails->mortgageRequest->house->name }}</h2>
                                <div class="flex items-center gap-[6px]">
                                    <img src={{ asset('assets/images/icons/location.svg') }} alt="icon"
                                        class="size-5 shrink-0">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $installmentDetails->mortgageRequest->house->city->name }}</p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-x-[12px] gap-y-[18px]">
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    ...
                                    <p class="font-semibold text-sm leading-[21px]">{{ $installmentDetails->mortgageRequest->house->bedroom }} Bedroom</p>
                                </div>
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src={{ asset('assets/images/icons/slider-horizontal.svg') }} alt="icon"
                                        class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $installmentDetails->mortgageRequest->house->bathroom }} Bathroom</p>
                                </div>
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                ...
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src={{ asset('assets/images/icons/note-favorite.svg') }} alt="icon"
                                        class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $installmentDetails->mortgageRequest->house->certificate }}</p>
                                </div>
                                ...
                                <div class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                    <img src={{ asset('assets/images/icons/flash.svg') }} alt="icon"
                                        class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">{{ $installmentDetails->mortgageRequest->house->electric }} Watts</p>
                                </div>
                            </div>
                        </div>
                    </section>
                    <section id="KPRPaymentDetails"
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <strong class="font-semibold">
                                    Rp {{ number_format($installmentDetails->sub_total_amount, 0, '','.') }}
                                </strong>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-2">
                                ...
                                <strong class="font-semibold">
                                    Rp {{ number_format($installmentDetails->total_taxt_amount, 0, '','.') }}
                                </strong>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-2">
                                ...
                                <strong class="font-semibold">
                                    Rp {{ number_format($installmentDetails->insurance_amount, 0, '','.') }}
                                </strong>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-2">
                                ...
                                <strong class="font-bold text-[20px] leading-[30px] text-tedja-blue">
                                    Rp {{ number_format($installmentDetails->grand_total_amount, 0, '','.') }}
                                </strong>
                            </div>
                        </div>
                        <hr class="border-[#F2F2F4]">
                        <div class="flex flex-col gap-4">
                            <div class="flex items-center justify-between">
                                ...
                                <strong class="font-semibold">{{ $installmentDetails->payment_type }}</strong>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-2">
                                    <img src={{ asset('assets/images/icons/note.svg') }} alt="icon"
                                ...
                                <strong class="font-semibold">{{ $installmentDetails->created_at->format('d M, Y') }}</strong>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-2">
                                    <img src={{ asset('assets/images/icons/note.svg') }} alt="icon"
