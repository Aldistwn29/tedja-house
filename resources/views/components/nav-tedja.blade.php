<nav class="relative w-full flex items-center justify-center px-[75px]">
    <div
        ...
        <a href="{{ route('front.index') }}" class="flex sharink-0">
        ...
        <ul class="flex items-center gap-[30px]">
            ...
            <li class="group">
                <a href="category.html"
                    class="hover:font-bold group-[.active]:font-bold transition-all duration-300">Favorites</a>
            </li>
            <li class="group">
                <a href="#"
        ...
        @guest
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('register') }}"
                    ...
                    <span class="font-semibold group-hover:text-white transition-all duration-300">Sign Up</span>
                </a>
            </div>
        @endguest
        @auth()
            <button id="Profile" class="relative">
                ...
                <ul
                    ...
                    <li>
                        <a href="{{ route('dashboard.mortgages') }}" class="hover:text-tedja-blue transition-all duration-300">My
                            Mortgages</a>
                    </li>
                    <li>
